...
class MockEmbeddingProvider(EmbeddingProvider):
    ...
    def _embed_one(self, text: str) -> list[float]:
        ...
        if norm == 0.0:
            # empty/626 unknown text → stable non-zero unit vector
            vec[0] = 1.0
            return vec
...
class MockLLMProvider(LLMProvider):
    ...
    async def complete(
        ...
        # Deterministic, grounded-looking reply that echoes the retrieved context when present.
        ...
        if context:
            ...
            body = (
                "Thank you for reaching out. We are looking into your request and will "
                "follow up shortly."
            )
